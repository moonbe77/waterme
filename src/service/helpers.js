...
function calculateNotificationDate(xDays, notificationTime) {
    console.log('calculateNotificationDate', { xDays: xDays, notificationTime: notificationTime });
    if (!notificationTime) {
    ...
    var _a = notificationTime.toLocaleTimeString().split(':'), hours = _a[0], minutes = _a[1];
